...
public class SignUpClientActivity extends AppCompatActivity {
    ...
    public void init(){
        btnInregistrare=(Button)findViewById(R.id.sign_up_client_btn_inregistrare);
        etEmail=(EditText)findViewById(R.id.sign_up_client_et_email);
        etParola=(EditText)findViewById(R.id.sign_up_client_et_parola);
